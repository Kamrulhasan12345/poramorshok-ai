...
const translations: { [lang in Language]: { [key: string]: string } } = {
	...
	bn: {
		...
		aiAnalysisDisclaimer:
			"আপনার দেওয়া লক্ষণগুলির উপর ভিত্তি করে এখানে একটি বিশ্লেষণ দেওয়া হলো। দয়া করে মনে রাখবেন, এটি কোনও ডাক্তারি পরামর্শের বিকল্প নয়।",
		...
		teamTitle: "আমাদের সম্পর্কে",
		teamText: `আমরা, 'টিম লাস্ট মিনিট', টেকনোভেশন ২৫ হ্যাকাথন উপলক্ষে এই অ্যাপটি তৈরি করি। জনগণের স্বাস্থ্যে ইতিবাচক ও বাস্তবসম্মত পরিবর্তন সাধনের লক্ষ্যে আমাদের এই ক্ষুদ্র প্রয়াস।\n\nটিম লাস্ট মিনিট:\n১। মোহাম্মদ কামরুল হাসান (শিক্ষার্থী, বাংলাদেশ প্রকৌশল বিশ্ববিদ্যালয়)\n২। মো জারিফ আজফার (শিক্ষার্থী, আমেরিকান-ইন্টারন্যাশনাল ইউনিভার্সিটি-বাংলাদেশ)\n৩। শেখ মাশরাফি মোহাম্মদ (শিক্ষার্থী, ইসলামিক ইউনিভার্সিটি অব টেকনোলজি, ওআইসি)`,
		// Login/Signup
		signUp: "সাইন আপ",
		signIn: "সাইন ইন",
		back: "পিছনে",
