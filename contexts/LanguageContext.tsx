...
const translations: { [lang in Language]: { [key: string]: string } } = {
	en: {
		...
		planSelectionDescription: "Select a plan that fits your needs",
		basicPlan: "Basic Plan",
		proPlan: "Pro Plan",
		free: "Free",
		basicPlanFeatures: "• AI Health Analysis\n• Health Tracker\n• Diet & Exercise Plans\n• Health Wallet\n• Nearby Hospitals (5 uses)",
		proPlanFeatures: "• Everything in Basic\n• Unlimited Nearby Hospitals\n• Priority Support\n• Advanced Analytics",
		selectBasicPlan: "Select Basic Plan",
		selectProPlan: "Select Pro Plan",
		currentPlan: "Current Plan",
		nearbyUsageLimit: "Nearby Usage Limit",
		usageRemaining: "{remaining} of {limit} uses remaining",
		usageExhausted: "You have used all {limit} free nearby searches",
		upgradeRequired: "Upgrade Required",
		upgradeToProMessage: "Upgrade to Pro plan for unlimited nearby hospital searches",
	...
	bn: {
		...
		planSelectionDescription: "আপনার প্রয়োজনের জন্য একটি প্ল্যান নির্বাচন করুন",
		basicPlan: "বেসিক প্ল্যান",
		proPlan: "প্রো প্ল্যান",
		free: "বিনামূল্যে",
		basicPlanFeatures: "• এআই স্বাস্থ্য বিশ্লেষণ\n• স্বাস্থ্য ট্র্যাকার\n• ডায়েট ও ব্যায়াম পরিকল্পনা\n• হেলথ ওয়ালেট\n• কাছাকাছি হাসপাতাল (৫ বার ব্যবহার)",
		proPlanFeatures: "• বেসিক এর সবকিছু\n• সীমাহীন কাছাকাছি হাসপাতাল\n• অগ্রাধিকার সাহায্য\n• উন্নত বিশ্লেষণ",
		selectBasicPlan: "বেসিক প্ল্যান নির্বাচন করুন",
		selectProPlan: "প্রো প্ল্যান নির্বাচন করুন",
		currentPlan: "বর্তমান প্ল্যান",
		nearbyUsageLimit: "কাছাকাছি ব্যবহারের সীমা",
		usageRemaining: "{limit} এর মধ্যে {remaining} বার ব্যবহার বাকি",
		usageExhausted: "আপনি সব {limit}টি বিনামূল্যে কাছাকাছি অনুসন্ধান ব্যবহার করেছেন",
		upgradeRequired: "আপগ্রেড প্রয়োজন",
		upgradeToProMessage: "সীমাহীন কাছাকাছি হাসপাতাল অনুসন্ধানের জন্য প্রো প্ল্যানে আপগ্রেড করুন",
		upgradeToPro: "প্রো তে আপগ্রেড করুন",
		paymentComingSoon: "পেমেন্ট ইন্টিগ্রেশন শীঘ্রই আসছে",
	},
};
